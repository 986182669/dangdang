...
<div class="header_top">
    <div class="header_top_left">您好！欢迎光临当当网 [<a href="login.jsp" target="_parent">登录</a> | <a href="register.html" target="_parent">免费注册</a>]</div>
...
<div class="header_middle">
    ...
    <div class="menu_left">
        ...
        <ul id="menu_left_bold">
            ...
            <li>|</li>
            <li><a href="product.jsp" target="_parent" class="bold">图书</a></li>
            <li>|</li>
