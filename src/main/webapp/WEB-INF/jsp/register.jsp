...
<div id="header">
    <div id="register_header">
        ...
        <div class="register_header_right"><a href="index.html" class="blue">首页</a> | <a href="product.jsp" class="blue">商品展示页</a>  | <a href="shopping.jsp" class="blue">购物车</a> |  <a href="login.jsp" class="blue">登录</a></div>
    </div>
</div>
<div id="main">
    <div class="register_content">
        ...
        <div class="register_mid_bg">
            <ul>
                <li class="register_mid_left" id="head1">填写注册信息</li>
                <li class="register_mid_mid" id="head2">2. 邮箱验证</li>
                <li class="register_mid_right" id="head3">3. 完成注册</li>
            </ul>
        </div>
        ...
        <div class="register_message" id="message_form">
            <form action="##" onsubmit="return false;" method="post" id="myform">
                ...
                <dl class="register_row" id="selectId">
                    <dt>所在地区：</dt>
                    <dd>
...
<!--网站版权部分开始-->
<div id="footer">
    <iframe src="/footer" height="50px" width="900px" frameborder="0"></iframe>
</div>
</body>
</html>
