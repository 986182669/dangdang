...
<div id="header">
    ...
    <div class="login_header_right"><a href="index.html" class="blue">首页</a> | <a href="product.jsp" class="blue">商品展示页</a>  | <a href="shopping.jsp" class="blue">购物车</a> | <a href="register.html" class="blue">注册</a></div>
</div>
...
<div id="main">
    ...
    <div class="login_main_mid">
        ...
        <form id="loginForm" action="##" method="post" onsubmit="false">
